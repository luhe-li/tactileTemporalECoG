...
hold on
plot([0.04 1.3], [0 0], 'k', 'LineWidth', 1, 'HandleVisibility','off')
plot(xvalues .* [1; 1], fmri_ci_95(2:numel(onePulseIndx),:)', 'Color', [0.8 0.8 0.8], 'LineWidth', 2, 'HandleVisibility', 'off')
plot(xvalues.* [1; 1], fmri_ci_68(2:numel(onePulseIndx),:)', 'Color', [0 0 0], 'LineWidth', 2, 'HandleVisibility', 'off')
plot(xvalues, fmri_summed_data(2:numel(onePulseIndx), :), '.k', 'MarkerSize', 25,  'HandleVisibility', 'off')
...
hold on
plot([0.04 1.3], [0 0], 'k', 'LineWidth', 1, 'HandleVisibility','off')
plot(xvalues .* [1; 1], fmri_ci_95((2+numel(onePulseIndx)):end,:)', 'Color', [0.8 0.8 0.8], 'LineWidth', 2, 'HandleVisibility', 'off')
plot(xvalues .* [1; 1], fmri_ci_68((2+numel(onePulseIndx)):end,:)', 'Color', [0 0 0], 'LineWidth', 2, 'HandleVisibility', 'off')
plot(xvalues,  fmri_summed_data((2+numel(onePulseIndx)):end, :), '.k', 'MarkerSize', 25,  'HandleVisibility', 'off')
...
hold on
plot([-0.05 1.3], [0 0], 'k', 'LineWidth', 1, 'HandleVisibility','off')
plot([0 xvalues].* [1; 1], fmri_ci_95(1:numel(onePulseIndx),:)', 'Color', [0.8 0.8 0.8], 'LineWidth', 2, 'HandleVisibility', 'off')
plot([0 xvalues].* [1; 1], fmri_ci_68(1:numel(onePulseIndx),:)', 'Color', [0 0 0], 'LineWidth', 2, 'HandleVisibility', 'off')
plot([0 xvalues],  fmri_summed_data(1:numel(onePulseIndx), :), '.k', 'MarkerSize', 10,  'HandleVisibility', 'off')

ax6 = nexttile(t3,[1 1]);
hold on
plot([-0.05 1.3], [0 0], 'k', 'LineWidth', 1, 'HandleVisibility','off')
plot([0 xvalues] .* [1; 1], fmri_ci_95((1:numel(onePulseIndx))+numel(onePulseIndx),:)', 'Color', [0.8 0.8 0.8], 'LineWidth', 2, 'HandleVisibility', 'off')
plot([0 xvalues] .* [1; 1], fmri_ci_68((1:numel(onePulseIndx))+numel(onePulseIndx),:)', 'Color', [0 0 0], 'LineWidth', 2, 'HandleVisibility', 'off')
plot([0 xvalues],  fmri_summed_data((1:numel(onePulseIndx))+numel(onePulseIndx), :), '.k', 'MarkerSize', 10,  'HandleVisibility', 'off')

% DM prediction)
plot(ax2, xvalues, fmri_pred(predOnePulseIndx), 'Color', modelColors(1,:), 'LineWidth', 1.5)
plot(ax3, 0, fmri_pred(predTwoPulseIndx(1)), 'Color', modelColors(1,:), 'LineWidth', 1.5)
plot(ax4, xvalues, fmri_pred(predTwoPulseIndx(2:end)), 'Color', modelColors(1,:), 'LineWidth', 1.5)
plot(ax5, xvalues, fmri_pred(predOnePulseIndx), 'Color', modelColors(1,:), 'LineWidth', 1.5 )
plot(ax6, [0 xvalues], fmri_pred(predTwoPulseIndx), 'Color', modelColors(1,:), 'LineWidth', 1.5 )

% Linear prediction
lin_pred = sum(fmri_results(1).y_est,1);
plot(ax2, [0 xvalues], lin_pred(onePulseIndx), 'Color', modelColors(2,:), 'LineWidth', 1.5)
plot(ax3, 0, lin_pred(twoPulseIndx(1)), 'Color', modelColors(2,:), 'LineWidth', 1.5)
plot(ax4, xvalues, lin_pred(twoPulseIndx(2:end)), 'Color', modelColors(2,:), 'LineWidth', 1.5)
plot(ax5, [0 xvalues], lin_pred(onePulseIndx), 'Color', modelColors(2,:), 'LineWidth', 1.5 )
plot(ax6, [0 xvalues], lin_pred(twoPulseIndx), 'Color', modelColors(2,:), 'LineWidth', 1.5 )
