function [err, pred] = DN_fixw(param, data, stim, srate)
%
% function [err, pred, numrsp, demrsp] = DN(param, data, stim, srate)
% INPUTS  -----------------------------------------------------------------
% params : 7 fields.
%          1. tau1 -- time to peak for positive IRF (seconds)
%          2. weight -- ratio of negative to positive IRFs (fixed to 0
%               for uniphasic irf)
...
fields = {'tau1', 'tau2', 'n', 'sigma', 'shift', 'scale'};
