...
brclt = [227, 27, 27; 30, 120, 180]./255;
...
if ~exist(saveDir, 'dir'), mkdir(saveDir), end
    saveas(gca, fullfile(saveDir, 'tactile_fits'), 'epsc')
close;
...
for zz = 1:length(modelfuns)
    [allD(zz)] = tde_loadDataForFigure(modelfuns{zz}, xvalmode, datatype);
end
[results] = tde_evaluateModelFit(allD,0);
...
saveas(gca, fullfile(saveDir, 'visual_fits'),'epsc')
close;
